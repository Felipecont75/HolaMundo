...
CREATE TABLE `valorant` (
  `ID` int(11) NOT NULL AUTO_INCREMENT,
  `Usuario_Agente` varchar(50) NOT NULL,
  `Nombre_Agente` varchar(50) NOT NULL,
  `Pasiva_del_Agente` varchar(30) NOT NULL,
  `Nacionalidad_del_Agente` varchar(50) NOT NULL,
...
LOCK TABLES `valorant` WRITE;
/*!40000 ALTER TABLE `valorant` DISABLE KEYS */;
/*!40000 ALTER TABLE `valorant` ENABLE KEYS */;
UNLOCK TABLES;
